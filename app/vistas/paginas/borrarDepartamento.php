...
<html lang="en">
    ...
    <body>
                ...
                <a href="<?php echo RUTA_URL; ?>/Departamentos" class="btn btn-light"><i class="fa fa-backward"></i>Volver</a>
                    <header>Borrar informacion de clientes</header>
            
                    <form action="<?php echo RUTA_URL; ?>/departamentos/borrar/<?php echo $datos['id_departamento'] ?>" method="POST" class="form">
